<template>
  <div class="table-container">
    <CustomTable :title="t('clientList.title')" fieldAsID="id_rec" fieldAsActive="is_active" :columns="columns"
      ...
      <template #form>
        <FloatLabel>
          <InputText v-model="model.amoun_rec" id="name" fluid></InputText>
          <label for="name"> {{ $t('clientForm.nameLabel') }}</label>
        </FloatLabel>
        <FloatLabel>
          <InputText v-model="model.amoun_rec" id="address" fluid></InputText>
          <label for="address"> {{ $t('clientForm.addressLabel') }}</label>
        </FloatLabel>
        <FloatLabel>
          <InputText v-model="model.amoun_rec" id="phone" fluid></InputText>
          <label for="phone"> {{ $t('clientForm.phoneLabel') }}</label>
        </FloatLabel>
        <FloatLabel>
          <Textarea v-model="model.amoun_rec" id="description" fluid></Textarea>
